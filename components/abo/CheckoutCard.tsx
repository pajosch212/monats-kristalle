...
const checklist = [
  ...
  { text: "2 Wochen Bedenkzeit — völlig risikolos", image: asset("/images/crystals/aquamarin.png") },
];
  ...
  return (
    <section className="w-full px-4 md:px-6 py-16 md:py-20">
      <div className="max-w-lg mx-auto bg-card border-[1.5px] border-ink rounded-3xl p-8 md:p-10 text-center">
        ...
        <p className="mt-4 text-xs text-taupe/85">2 Wochen Bedenkzeit · monatlich kündbar</p>
      </div>
    </section>
  );
}
